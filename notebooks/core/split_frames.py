...
def split_dataset1(frames1, frames_json, patch_dir, test_size = 0.2, val_size = 0.2):
    ...
    if os.path.isfile(frames_json):
        ...
        frames_list = list(range(len(frames1)))
...
def split_dataset2(frames1,frames_12, frames_json, patch_dir, test_size = 0.2, val_size = 0.2):
    if os.path.isfile(frames_json):
        print("Reading train-test split from file")
        with open(frames_json, 'r') as file:
            fjson = json.load(file)
        ...
        print("Creating and writing train-test split from file")
        frames_list = list(range(len(frames1),len(frames_12)))
        # Divide into training and test set      
        training_frames, testing_frames = train_test_split(frames_list, test_size=test_size)
...
def split_dataset3(frames_12,frames_123, frames_json, patch_dir, test_size = 0.2, val_size = 0.2):
    if os.path.isfile(frames_json):
        print("Reading train-test split from file")
        with open(frames_json, 'r') as file:
            fjson = json.load(file)
        ...
        print("Creating and writing train-test split from file")
        frames_list = list(range(len(frames_12),len(frames_123)))
        # Divide into training and test set      
        training_frames, testing_frames = train_test_split(frames_list, test_size=test_size)
...
def split_dataset4(frames_123,frames_1234,frames_json,patch_dir, test_size = 0.2, val_size = 0.2):
    if os.path.isfile(frames_json):
        print("Reading train-test split from file")
        with open(frames_json, 'r') as file:
            fjson = json.load(file)
        ...
        print("Creating and writing train-test split from file")
        frames_list = list(range(len(frames_123),len(frames_1234)))
        # Divide into training and test set       
        training_frames, testing_frames = train_test_split(frames_list, test_size=test_size)
...
# def split_dataset5(frames_1234,frames_12345,frames_json,patch_dir, test_size = 0.2, val_size = 0.2):
#     if os.path.isfile(frames_json):
#         print("Reading train-test split from file")
#         with open(frames_json, 'r') as file:
#             fjson = json.load(file)
...
#     else:
#         print("Creating and writing train-test split from file")
#         frames_list = list(range(len(frames_1234),len(frames_12345)))
#         # Divide into training and test set       
#         training_frames, testing_frames = train_test_split(frames_list, test_size=test_size)
